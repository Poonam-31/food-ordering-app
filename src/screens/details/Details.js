        ...
        return (
            ...
            <div><Header baseUrl={this.props.baseUrl}/>
                ...
                <div className="main-container-body">
                    ...
                    <Snackbar open={this.state.open} closeHandler={this.closeHandler}
                                        message="Item added to cart!"/>
                    <Snackbar open={this.state.cartEmpty} closeHandler={this.closeHandler}
                                        message="Please add an item to your cart!"/>
                    <Snackbar open={this.state.itemQuantityDecreased} closeHandler={this.closeHandler}
                                        message="Item quantity decreased by 1!"/>
                    <Snackbar open={this.state.nonloggedIn} closeHandler={this.closeHandler}
                                        message="Please login first!"/>
                    <Snackbar open={this.state.itemRemovedFromCart} closeHandler={this.closeHandler}
                        message="Item removed from cart!" />
                    <Snackbar open={this.state.itemQuantityIncreased} closeHandler={this.closeHandler}
